...
let getting = document.querySelectorAll('.getting-product-box-title')

getting.forEach(function(item){
    
    item.addEventListener('click',function(){
       
        let iditem = this.getAttribute('data-id')
        document.getElementById(iditem).classList.toggle('getting-product-box-conent-active')
